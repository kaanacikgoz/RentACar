...
public class Book {
    ...
    public String toString() {
        return STR."Book{id=\{id}, car_id=\{car_id}, car=\{car}, name='\{name}\{'\''}, idno='\{idno}\{'\''}, mpno='\{mpno}\{'\''}, mail='\{mail}\{'\''}, strt_date=\{strt_date}, fnsh_date=\{fnsh_date}, bCase='\{bCase}\{'\''}, note='\{note}\{'\''}, prc=\{prc}\{'}'}";
    }
