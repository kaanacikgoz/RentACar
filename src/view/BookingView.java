...
public class BookingView extends Layout {
    ...
    public BookingView(Car selectedCar, String strt_date, String fnsh_date) {
        ...
        this.add(container);
        this.guiInitialize(300,600);

        this.lbl_car_info.setText(STR."Araç : \{this.car.getPlate()} / \{this.car.getModel().getBrand().getName()} / \{this.car.getModel().getName()}");

        this.fld_book_strt_date.setText(strt_date);
        this.fld_book_fnsh_date.setText(fnsh_date);

        btn_booking_save.addActionListener(_ -> {
